...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME =  1000 * 60 * 30 * 24 * 7 * 30 * 3;            // 30분
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 7 * 30 * 3;  // 7일
